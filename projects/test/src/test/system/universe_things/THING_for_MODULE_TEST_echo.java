...
import test.system.modules.set1.MODULE_TEST_echo;
...
/**
 * A thing for testing MODULE_TEST_echo.  It will define a single result and pass it.<br>      
 *<p>
 * NOTES:<br>
 ...
 * </pre> 
 */
public class THING_for_MODULE_TEST_echo extends THING {
	...
	public void PROCESS() throws Throwable {
		...
		MODULE_TEST_echo testModule = (MODULE_TEST_echo)this.INSTANCE("test.system.modules.set1.MODULE_TEST_echo");
		String result = testModule.ping("borkity");
		if (result.equals("borkity")) SET_RESULT(RESULT_NAME_1, Data.Type.PASS);
		else SET_RESULT(RESULT_NAME_1, Data.Type.FAIL);
