...
/**
 * A thing for testing RUN.  This is the root C for set1 tests.  This will check call, including parameter works, and result actions.<br>      
 ...
 * </pre>
 */
public class THING_TEST_set1RootC extends THING {
	 ...
	 * Names.
	 */
	public final static String RESULT_SET1ROOTC_STEP1 = "set1RootC.step1.passfail";
	public final static String RESULT_SET1ROOTC_STEP1_DESC = "set1RootC.step1.passfail.  Property tests.";
	...
	public void DEFINITION() throws UserException {
		DEFINE_RESULT(RESULT_SET1ROOTC_STEP1, RESULT_SET1ROOTC_STEP1_DESC, ResultExpectation.PASS_FAIL);
	}
	...
	public void PROCESS() throws Throwable {
		...
		SET_RESULT(RESULT_SET1ROOTC_STEP1, step2Result);	
