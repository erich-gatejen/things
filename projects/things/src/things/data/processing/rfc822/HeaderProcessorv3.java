...
/**
 * Processes headers.  Read only.  Based on v1<p>
 ...
 * </pre> 
 */
public abstract class HeaderProcessorv3 extends InputStream  {
	...
	// =========================================================================================
	// CONSTRUCTOR
	public HeaderProcessorv3() throws Throwable {
	 ...
	 * @throws Throwable
	 */
	abstract protected void match(int	id) throws Throwable;
	 ...
	 * @throws Throwable
	 */
	abstract protected void unmatch(byte[] headerBuffer, 		int size) throws Throwable;
	 ...
	 * @throws Throwable
	 */
	abstract protected List<String> complete() throws Throwable;
	 ...
	 * @throws Throwable
	 */
	public synchronized List<String> process(String messageId, InputStream input) throws Throwable {
			...
			try {
				...
				while (character >= 0) {
					...
					if (currentColumn == STATE_NONE) {
						...
						unmatch(headerBuffer, headerBufferLength);
