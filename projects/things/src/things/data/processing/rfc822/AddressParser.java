 ...
 * </pre> 
 */
public class AddressParser extends LexicalTool {
	...
	static public void parseAndSave(StreamSource source, AddressListener addressListener) throws Throwable {
		...
		AddressParser instanceParser = new AddressParser();
...
//		-> ($FLAG_GROUP_ENDED = true)	- false->$FLAG_GROUP_ENDED, ^RETURN^
	private void OPEN() throws Throwable {
		...
		while (ios.hasMore()) {
			...
			case SPECIAL_GT: case SPECIAL_AT: case SPECIAL_OPENBRACK: case SPECIAL_BACKSLASH: case SPECIAL_CLOSEBRACK:
